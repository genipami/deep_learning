...
def main():
    ...
    fig, ((hist_1950, hist_2007)) = plt.subplots(nrows=1,
                                                 ncols=2,
                                                 sharex=True,
                                                 sharey=True)
    hist_2007.hist(life_exp2007,
                   bins=range(30, 86, 5),
                   linewidth=0.5,
                   edgecolor="white")
    hist_1950.hist(life_exp1950,
                   bins=range(30, 86, 5),
                   linewidth=0.5,
                   edgecolor="white")

    hist_1950.set_title("Life expectancy in 1950")
    hist_2007.set_title("Life expectancy in 2007")
    hist_1950.set_xlabel("Life expectancy")
    hist_2007.set_xlabel("Life expectancy")

    plt.tight_layout()
    plt.show()

    #The most common life expectancy in 1950 was between 40-45 years, followed by 35-40 and 65-70 years. The life expectancy doesn't follow a normal distibution or a uniform one.
    #The most common life expectancy in 2007 was between 70-75 years, followed by 75-80 and 80-85 years. The life expectancy doesn't follow a normal distibution or a uniform one.
    #Life expectancy has dramatically increased from 1950 to 2007.The differences are in the most common bins and the overall distribution. The histogram from 1950 is almost shifted to the right compared in the 2007 histogram.
